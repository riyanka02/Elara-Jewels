document.addEventListener("DOMContentLoaded", () => {
  ...
  // Wishlist toggle buttons on products
  ...
  // Redirect to wishlist page on navbar icon click
  ...
  document.querySelectorAll('.wishlist-btn').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      const productImage = btn.dataset.image; // Get the image URL from data-image

      // Find the product image element by its ID
      const productImageElement = document.getElementById(`product-image-${productId}`);
      if (productImageElement) {
        productImageElement.src = productImage; // Update the image source dynamically
      }
